...
import img from "../assets/image/feature.jpg";
import pic1 from "../assets/image/service.png";
import pic2 from "../assets/image/user.png";
import pic3 from "../assets/image/wallet.png";
        ...
        <div className=" min-h-screen flex flex-col lg:flex-row items-center md:mx-32 mx-5 gap-14">
            <div className=" w-full lg:w-2/4">
                <div className=" space-y-4">
                    ...
                    <p>
                        Discover the Best Holiday Experiences with Trivago! We're
